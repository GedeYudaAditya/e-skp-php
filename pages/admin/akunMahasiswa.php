    ...
    <div id="content">
        ...
        <div class="container-fluid isinya">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <!-- <a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-sm text-white-50"></i>Tambahkan Admin</a> -->
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="" method="post" onsubmit="return confirm('Do you really want to submit the form?');">
                                        ...
                                        <button type="submit" name="deleteMahasiswa" class="btn btn-danger">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Update Akun Mahasiswa</h1>
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="updateMahasiswa" class="btn btn-primary">Save changes</button>
                    </div>
                </form>
            </div>
        </div>
